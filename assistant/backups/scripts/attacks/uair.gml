...
set_window_value(AT_UAIR, 2, AG_WINDOW_LENGTH, 13);
...
set_hitbox_value(AT_UAIR, 1, HG_LIFETIME, 13);
...
set_hitbox_value(AT_UAIR, 2, HG_LIFETIME, 13);
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_X, 18);
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -23);
