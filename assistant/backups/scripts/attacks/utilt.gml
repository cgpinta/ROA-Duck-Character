set_attack_value(AT_UTILT, AG_SPRITE, sprite_get("uair"));
set_attack_value(AT_UTILT, AG_NUM_WINDOWS, 3);
set_attack_value(AT_UTILT, AG_HURTBOX_SPRITE, sprite_get("uair_hurt"));
...
set_hitbox_value(AT_UTILT, 1, HG_LIFETIME, 13);
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_X, 28);
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_Y, -33);
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 13);
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 15);
...
set_hitbox_value(AT_UTILT, 2, HG_LIFETIME, 13);
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_X, 18);
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -23);
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 13);
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 13);
