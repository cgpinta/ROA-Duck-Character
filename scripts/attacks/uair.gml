set_attack_value(AT_DAIR, AG_SPRITE, sprite_get("uair"));
set_attack_value(AT_DAIR, AG_NUM_WINDOWS, 4);
set_attack_value(AT_DAIR, AG_HURTBOX_SPRITE, sprite_get("uair_hurt"));
...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 13);
...
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 13);
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 13);
...
set_hitbox_value(AT_DAIR, 2, HG_KNOCKBACK_SCALING, .55);
