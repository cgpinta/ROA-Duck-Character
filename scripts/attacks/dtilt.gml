set_attack_value(AT_DSTRONG, AG_SPRITE, sprite_get("dtilt"));
set_attack_value(AT_DSTRONG, AG_NUM_WINDOWS, 3);
set_attack_value(AT_DSTRONG, AG_STRONG_CHARGE_WINDOW, 0);
set_attack_value(AT_DSTRONG, AG_HURTBOX_SPRITE, sprite_get("dtilt_hurt"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, 11);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, 26);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -7.5);
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 32);
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 8);
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 16);
