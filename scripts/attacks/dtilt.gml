set_attack_value(AT_FTILT, AG_SPRITE, sprite_get("dtilt"));
set_attack_value(AT_FTILT, AG_NUM_WINDOWS, 3);
set_attack_value(AT_FTILT, AG_HURTBOX_SPRITE, sprite_get("dtilt_hurt"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -7.5);
