...
set_hitbox_value(AT_UTILT, 1, HG_LIFETIME, 60);
...
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_SPRITE, sprite_get("banana_proj"));
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_MASK, sprite_get("banana_proj"));
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_HSPEED, .9);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_VSPEED, -10);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_GRAVITY, .5);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_IS_TRANSCENDENT, false);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_WALL_BEHAVIOR, 2);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_GROUND_BEHAVIOR, 2);

set_hitbox_value(AT_UTILT, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 2, HG_WINDOW, 2);
set_hitbox_value(AT_UTILT, 2, HG_LIFETIME, 30);
