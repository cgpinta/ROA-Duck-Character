set_attack_value(AT_JAB, AG_SPRITE, sprite_get("ftilt"));
set_attack_value(AT_JAB, AG_NUM_WINDOWS, 3);
set_attack_value(AT_JAB, AG_HURTBOX_SPRITE, sprite_get("ftilt_hurt"));
...
set_hitbox_value(AT_JAB, 1, HG_HITBOX_Y, -12.5);
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 32);
set_hitbox_value(AT_JAB, 1, HG_HEIGHT, 6);
