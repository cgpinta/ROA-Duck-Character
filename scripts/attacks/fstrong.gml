...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 26);
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 39);
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 11);
...
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 39);
